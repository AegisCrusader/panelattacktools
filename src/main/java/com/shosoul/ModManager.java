...
public class ModManager extends JPanel implements ActionListener {
    ...
    public ModManager(boolean dontusethisone) {
        super(new GridLayout(1, 0));
        this.setSize(1000, 1000);
        JTabbedPane tabbedPane = new JTabbedPane();

        JComponent modPanel = makePanel("Mod Panel");
        tabbedPane.addTab("Mods", modPanel);
        tabbedPane.setMnemonicAt(0, KeyEvent.VK_1);

        JComponent stagePanel = makePanel("Stage Panel");
        tabbedPane.addTab("Stages", stagePanel);
        tabbedPane.setMnemonicAt(1, KeyEvent.VK_2);

        JComponent panel3 = makePanel("Validation Panel");
        tabbedPane.addTab("Validation", panel3);
        tabbedPane.setMnemonicAt(2, KeyEvent.VK_3);

        JComponent panel4 = makePanel("Mod Maker");
        tabbedPane.addTab("Mod Maker 2 Electric Boogaloo", panel4);
        ...
        // modTab = makeTextPanel("Mods");
        // tabPane.addTab("Mods", modTab);
        for (PanelAttackCharacter character : PanelAttackCharacter.getCharacters(true)) {
            ...
            // if (icon!=null) {
            // item= new JCheckBox(character.getName(), icon, character.isEnabled());
            // }
        ...
        for (PanelAttackStage stage : PanelAttackStage.getStages(false)) {
        ...
        fileMenu.setMnemonic(KeyEvent.VK_F); // Alt + f for file
        editMenu.setMnemonic(KeyEvent.VK_E); // Alt + e for edit
        viewMenu.setMnemonic(KeyEvent.VK_H); // Alt + h for help
        refreshItem.setMnemonic(KeyEvent.VK_R); // r for refresh
        openItem.setMnemonic(KeyEvent.VK_S); // s for save
        exitItem.setMnemonic(KeyEvent.VK_E); // e for exit
